        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="loginModalLabel">Khôi phục mật khẩu </h5>
                ...
                <div class="modal-body">
                    <form method="post" id="loginForm">
                        ...
                        <div class="mb-3">
                            <label for="login_tendangnhap" class="form-label">Email <span
                                    class="text-danger">*</span></label>
                            <input type="email" class="form-control" id="login_tendangnhap" name="tendangnhap"
                                value="<?php echo isset($tendangnhap) ? htmlspecialchars($tendangnhap) : ''; ?>"
                                required>
                        </div>
                    ...
                    <div class="text-center mt-3" hidden>
                        <p>Chưa có tài khoản? <a href="#" data-bs-toggle="modal" data-bs-target="#registerModal"
                                data-bs-dismiss="modal" hidden>Đăng ký ngay</a></p>
                    </div>
                </div>
            </div>
        </div>
